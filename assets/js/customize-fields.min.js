...
jQuery(function ($) {
    ...
    if (document.getElementsByClassName('ctoolkit-repeater').length) {
        $('#widgets-right .ctoolkit-repeater').ctoolkitRepeater();
    }

    if (document.getElementsByClassName('ctoolkit-map').length) {
        $('#widgets-right .ctoolkit-map').ctoolkitMap();
    }
    ...
    $('.accordion-section').on('expanded', function () {
        if ($(this).find('.ctoolkit-map:not(.child-field)').length) {
            $(this).find('.ctoolkit-map:not(.child-field)').ctoolkitMap();
        }
    });
