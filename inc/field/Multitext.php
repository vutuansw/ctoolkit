...
class Multitext extends \WP_Customize_Control {
	...
	public function field( $settings, $value ) {
		...
		<div class="ctoolkit-field ctoolkit-multitext">
			...
			<div class="bottom-row">
				<a href="#" class="addnew"><?php echo esc_html__( 'Add new', 'ctoolkit' ) ?></a>
			</div>
		</div>
		<?php
	}
	...
	public function field_item( $value = '' ) {
		...
		<li class="multitext-item">
			...
			<a class="remove" href="#" title="<?php echo esc_attr__( 'Remove', 'ctoolkit' ) ?>"><?php echo esc_html__( 'Remove', 'ctoolkit' ) ?></a>
			<a class="short" href="#" title="<?php echo esc_attr__( 'Short', 'ctoolkit' ) ?>"><?php echo esc_html__( 'Short', 'ctoolkit' ) ?></a>
		</li>
		<?php
	}
